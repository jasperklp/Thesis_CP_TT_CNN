...
change_kernel_padding_dict_1["padding"] = (1, 3)

change_kernel_padding_dict_2 = copy.deepcopy(base_dict)
change_kernel_padding_dict_2["kernel_size"] = (5,3)
change_kernel_padding_dict_2["padding"] = (3,1)



experiment_results = {}
experiment_results["Measurements"] = [base_dict, change_in_channel_dict, change_out_channel_dict, change_kernel_padding_dict_1,change_kernel_padding_dict_2]#, change_in_channel_dict, change_out_channel_dict, change_kernel_padding_dict_1,change_kernel_padding_dict_2]
...
if __name__ == "__main__": 
    ...
    for i in experiment_results["Measurements"]:
        ...
        print(f"Model: in_channel {in_channels} out_channel {out_channels}, kernel_size {kernel_size}")
        print("Uncomp")
