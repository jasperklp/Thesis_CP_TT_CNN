...
base_dict = {"in_channels" : 20, "out_channels" : 20, "kernel_size" : (3,5), "padding" : (1,1), "image_size" : 100, "rank" : 2, "epochs" : 1}
...
if __name__ == "__main__": 
    ...
    for i in experiment_results["Measurements"]:
        ...
        print("CP")
        measurement_outputs.append(runner.model_runner(CNN_models.cp_tensorly_model(in_channels=in_channels,out_channels=out_channels,kernel_size=kernel_size,padding=padding,rank=rank),epochs,image_size, verbose = True))
