...
if __name__ == "__main__":
    time = runner.model_runner(model_1, 100 ,4, verbose=True)
    time = runner.model_runner(model_2, 100, 4, verbose=True)
    print(time)

    [MAC, RAM] = model_1.MAC_and_RAM(4)
    print(f"RAM uncomp_model = {RAM/8/1000/1000}")

    [MAC, RAM] = model_2.MAC_and_RAM(4)
    print(f"RAM CP_model = {RAM/8/1000/1000}")